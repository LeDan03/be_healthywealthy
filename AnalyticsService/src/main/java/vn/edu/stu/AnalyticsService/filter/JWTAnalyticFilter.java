package vn.edu.stu.AnalyticsService.filter;
...
import vn.edu.stu.AnalyticsService.dto.MyPrincipal;
import vn.edu.stu.AnalyticsService.utils.JWTUtils;
...
public class JWTAnalyticFilter extends OncePerRequestFilter {

    private static final Logger log = LoggerFactory.getLogger(JWTAnalyticFilter.class);
